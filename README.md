...
My current/recent projects include an AI-powered smart CRM with MCP capabilities, benchmarking multi-agent communication structures using CrewAI & LangChain, and a sales forecasting tool developed in Python.
